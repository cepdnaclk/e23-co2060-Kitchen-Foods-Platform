  ...
  return (
    <div className="pt-32 pb-24 bg-brand-cream min-h-screen text-stone-900">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center mb-20">
        ...
        >
          Kitchen Foods isn't just about sharing incredible culinary heritage.
          It’s a movement to create financial independence for housewives and
          unemployed women across the country.
        </motion.p>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-12">
        <article className="prose prose-lg prose-stone max-w-none">
          <p className="text-xl leading-relaxed text-stone-600 mb-8 font-medium">
            Every day, millions of women pour their heart, culture, and
            generations of culinary secrets into the meals they prepare for
            their families. Yet, this labor of love is rarely recognized as the
            highly skilled economic driver that it truly is.
          </p>
          ...
          <p className="text-lg leading-relaxed text-stone-600 mb-8">
            We started Kitchen Foods to bridge the gap between incredible,
            authentic home cooking and the people who crave it. But our
            underlying mission is deeply personal: we want to transform kitchens
            from spaces of unpaid labor into launchpads for female
            entrepreneurship.
          </p>
          <p className="text-lg leading-relaxed text-stone-600 mb-12">
            By providing an easy-to-use digital storefront, logistics support,
            and marketing, housewives can immediately begin generating income.
            They set their own hours, decide their own menus, and run their
            businesses entirely from the comfort of their homes.
          </p>
          ...
          <div className="grid sm:grid-cols-3 gap-6 my-16">
            <div className="bg-white p-8 rounded-3xl border border-stone-900/10 text-center shadow-sm">
              ...
              <div className="text-4xl font-bold font-serif text-stone-900 mb-2">
                42
              </div>
          ...
          <p className="text-lg leading-relaxed text-stone-600 mb-8">
            Many of our chefs are mothers or individuals previously classified
            as "unemployed." Today, they are registered micro-business owners.
            This financial autonomy brings profound changes beyond just
            supplementary income—it fosters confidence, community respect, and a
            protective financial safety net for their families.
          </p>
          ...
          <blockquote className="border-l-4 border-brand-primary pl-6 py-2 my-12 bg-white/50 rounded-r-2xl">
            <p className="text-2xl font-serif text-stone-900 italic mb-4">
              "Before Kitchen Foods, my cooking was just a chore. Now, it's my
              career. Being able to contribute financially without leaving my
              children has changed our lives."
            </p>
          ...
          <p className="text-lg leading-relaxed text-stone-600 mb-8">
            When you order from Kitchen Foods, you aren't just getting an
            incredibly delicious, customized meal. You are directly
            participating in the economic empowerment of a woman in your
            community.
          </p>
        </article>
        ...
        <div className="mt-20 p-12 bg-stone-900 rounded-[40px] text-center text-white relative overflow-hidden">
          ...
          <h3 className="text-3xl font-serif font-bold mb-6 relative z-10">
            Know someone who loves to cook?
          </h3>
          <p className="text-white/60 mb-8 max-w-lg mx-auto relative z-10">
            Help us grow our community. If you know a talented home cook looking
            to turn their passion into income, encourage them to apply.
          </p>
          <button
