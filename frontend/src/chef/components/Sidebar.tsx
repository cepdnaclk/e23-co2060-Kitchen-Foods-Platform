...
const SidebarContent = ({ activeTab, onTabChange, onLogout, onClose, profile, deliveredCount = 0, activeCount = 0, isOnline, setIsOnline }: SidebarContentProps) => {
  ...
  return (
    <div className="flex flex-col h-full w-64 bg-[#fdf8f3]/98 backdrop-blur-2xl border-r border-stone-900/10 relative overflow-hidden">
      {/* Decorative top glow */}
...
export const Sidebar = (props: SidebarProps) => {
  ...
  const sharedProps = { ...props, isOnline, setIsOnline };

  return (
    <>
      {/* Always-visible sidebar on large screens */}
      <div className="hidden lg:flex fixed inset-y-0 left-0 w-64 z-50 shadow-sm">
        ...
        {props.isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 left-0 w-64 z-50 flex lg:hidden shadow-2xl"
            >
              <SidebarContent {...sharedProps} />
            </motion.div>
          </>
